...
//test
 ...
 /* Twiddle factors, pq-crystals ref/ntt.c. zetas[0] is unused by the
    transforms; the basemul factors live at zetas[64..127]. */
 ...
 *              the plain product mod q (lazily reduced, as on hardware).
 *
 *              The two input copies match what the kernel does and are timed
 *              with the rest, but cost nothing measurable.
 *
 ...
 *              and far slower, but independent of the NTT, so it is what the
