...
/* Software reference for the poly_mul kernel, for the A53 baseline and for
   checking the hardware result. Self-contained: the pq-crystals reference NTT
   is reproduced here so the host builds without a kyber checkout on the
   board. Same code path bench/bench_poly_mul.cpp times. */
